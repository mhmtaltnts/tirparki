...
export function OfficialIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M77.89 50.036a8.845 8.845 0 0 0 8.848-8.845 8.845 8.845 0 0 0-8.848-8.846c-4.883 0-8.842 3.96-8.842 8.846 0 4.885 3.959 8.845 8.842 8.845zm10.118 3.569h-2.479l-6.661 16.033 1.993-8.99-2.139-2.372 2.139-2.696-3.013-3.234-3.114 3.342 2.14 2.587-2.14 2.48 1.994 8.633-6.531-15.785h-2.67c-2.348 0-4.249 1.931-4.249 4.312v20.529c0 2.381 1.901 4.312 4.249 4.312h20.48c2.348 0 4.25-1.93 4.25-4.312V57.917c.001-2.38-1.902-4.312-4.249-4.312z" />
    </svg>
  );
}
